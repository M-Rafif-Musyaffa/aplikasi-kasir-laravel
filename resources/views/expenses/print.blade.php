...
<body class="bg-white" onload="window.print()">
    ...
    <div class="p-8 max-w-4xl mx-auto">
        ...
        <div class="border-b pb-4 mb-6">
            <h1 class="text-3xl font-bold">Laporan Biaya Operasional</h1>
            ...
            <div class="text-sm text-gray-600 grid grid-cols-2">
                ...
                <p>Dicatat Oleh: <span class="font-semibold">{{ $filterUserName }}</span></p>
            </div>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-300 border border-gray-300">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @forelse ($expenses as $expense)
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-700">
                            {{ $expense->user->name ?? 'N/A' }}</td>
                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-700 text-right">
                            Rp{{ number_format($expense->amount, 0, ',', '.') }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-2 text-center text-sm text-gray-500">Tidak ada data biaya
                            untuk filter ini.</td>
                    </tr>
                @endforelse
            </tbody>
            <tfoot class="bg-gray-100 font-bold">
                <tr>
                    <td colspan="4" class="px-4 py-2 text-right text-sm uppercase">Total Biaya</td>
                    <td class="px-4 py-2 whitespace-nowrap text-lg text-red-600 text-right">
